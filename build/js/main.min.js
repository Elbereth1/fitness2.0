...
var _sandwich = require("./modules/sandwich.js");
var _phoneMask = require("./modules/phone-mask/phone-mask.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _slider.getSlider)();
  (0, _slider.getSubSlider)();
  (0, _sandwich.getToggleSandwich)();
  // Modules
  // ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/phone-mask/phone-mask.js":11,"./modules/sandwich.js":12,"./modules/slider.js":13,"./modules/tabs/init-tabs.js":14,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
exports.getToggleSandwich = void 0;
var sandwich = document.querySelector('.faq__sublist-button');
var list = document.querySelector('.faq > p');
var getToggleSandwich = exports.getToggleSandwich = function getToggleSandwich() {
...
exports.getSubSlider = exports.getSlider = void 0;
var Swiper = window.Swiper;
var getSlider = exports.getSlider = function getSlider() {
...
var getSubSlider = exports.getSubSlider = function getSubSlider() {
  return new Swiper('.swiper-sub', {
    slidesPerView: 3,
    // Pagination
